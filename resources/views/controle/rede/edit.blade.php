...
@section('conteudo')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Rede <small>{{ isset($rede) ? 'Editar' : 'Cadastrar' }}</small></h2>
                ...
                <div class="x_content">
                    ...
                    {!! Form::model(isset($rede)?$rede:null, ['route' => ['controle.rede.salvar', (isset($rede)?$rede->id:null)], 'class' => 'form-horizontal form-label-left']) !!}
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            {!! Form::submit(isset($rede) ? 'Editar' : 'Cadastrar', ['class' => 'btn btn-primary']) !!}
