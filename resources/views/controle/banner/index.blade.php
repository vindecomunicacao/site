            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('controle.banner.edit') }}" class="btn btn-success"><i class="fa fa-plus"></i> Novo</a>
                    </div>
                        ...
                        @foreach($banners as $banner)
                            <tr class="even pointer">
                                ...
                                <td class=" last">
                                    ...
                                    @endcan
                                    @can('banner.excluir')
                                        <a href="javascript:void(0);" class="btn btn-danger btn-xs excluir" data-url="{{ route('controle.banner.excluir', $banner) }}" data-toggle="modal" data-target=".bs-example-modal-sm"><i class="fa fa-times"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @endforeach
