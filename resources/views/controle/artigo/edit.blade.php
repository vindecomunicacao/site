...
@section('conteudo')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Artigo <small>{{ isset($artigo) ? 'Editar' : 'Cadastrar' }}</small></h2>
                ...
                <div class="x_content">
                    ...
                    {!! Form::model(isset($artigo)?$artigo:null, ['route' => ['controle.artigo.salvar', (isset($artigo)?$artigo->id:null)], 'class' => 'form-horizontal form-label-left', 'files' => true]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::file('imagem', ['class' => 'file-single col-md-7 col-xs-12', isset($artigo)?'':'required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            {!! Form::submit(isset($artigo) ? 'Editar' : 'Cadastrar', ['class' => 'btn btn-primary']) !!}
