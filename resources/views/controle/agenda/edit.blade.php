...
@section('conteudo')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Agenda <small>{{ isset($agenda) ? 'Editar' : 'Cadastrar' }}</small></h2>
                ...
                <div class="x_content">
                    ...
                    {!! Form::model(isset($agenda)?$agenda:null, ['route' => ['controle.agenda.salvar', (isset($agenda)?$agenda->id:null)], 'class' => 'form-horizontal form-label-left', 'files' => true]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::file('imagem', ['class' => 'file-single col-md-7 col-xs-12', isset($agenda)?'':'required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        {!! Form::label('permanente', 'Permanente', ['class' => 'control-label col-md-3 col-sm-3 col-xs-12']) !!}
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            {!! Form::checkbox('permanente', 1, null,['class' => 'form-control col-md-7 col-xs-12']) !!}
                        </div>
                    </div>
                    <div class="ln_solid"></div>
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            {!! Form::submit(isset($agenda) ? 'Editar' : 'Cadastrar', ['class' => 'btn btn-primary']) !!}
