...
<body class="nav-md">
    ...
    <!-- gauge js -->
    <script type="text/javascript" src="library/gauge/gauge.min.js"></script>
    <script type="text/javascript" src="library/gauge/gauge_demo.js"></script>
    <!-- daterangepicker -->
    <script type="text/javascript" src="library/moment.min2.js"></script>
    <script type="text/javascript" src="library/datepicker/daterangepicker.js"></script>
    <!-- sparkline -->
    <script src="library/sparkline/jquery.sparkline.min.js"></script>
    ...
    <!-- flot js -->
    <!--[if lte IE 8]>
    <script type="text/javascript" src="library/excanvas.min.js"></script><![endif]-->
    <script type="text/javascript" src="library/flot/jquery.flot.js"></script>
    <script type="text/javascript" src="library/flot/jquery.flot.pie.js"></script>
    <script type="text/javascript" src="library/flot/jquery.flot.orderBars.js"></script>
    <script type="text/javascript" src="library/flot/jquery.flot.time.min.js"></script>
    <script type="text/javascript" src="library/flot/date.js"></script>
    <script type="text/javascript" src="library/flot/jquery.flot.spline.js"></script>
    <script type="text/javascript" src="library/flot/jquery.flot.stack.js"></script>
    <script type="text/javascript" src="library/flot/curvedLines.js"></script>
    <script type="text/javascript" src="library/flot/jquery.flot.resize.js"></script>
    <!-- pace -->
    ...
    <!-- moris js -->
    <script src="library/moris/raphael-min.js"></script>
    <script src="library/moris/morris.js"></script>
    <script>
        $(function () {
            var day_data = [
                {
